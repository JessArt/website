...
export default class FeedbackForm extends Component {
  ...
  verify() {
    ...
    const nameError =
      name.length > MIN_NAME_LENGTH ? "" : "Please enter at least 2 characters";
    const emailError = "";
    const messageError =
    ...
    this.verify().then(res => {
      if (res) {
        ...
        this.setState({ isSending: true }, () => {
          post("/v1/feedback", { params: feedback }).then(() =>
        ...
        <form onSubmit={this.onSubmit}>
          ...
          <div className={styles.inputContainer}>
            <textarea
              ...
              value={message}
              rows={5}
              onChange={this.handleValue.bind(this, "message")}
            />
          </div>

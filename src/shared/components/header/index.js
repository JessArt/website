...
export default class Header extends Component {
  ...
  renderSmallHeader({ invisible = false } = {}) {
    ...
    const facebookIconMarkup = (
      <a
        className={styles.smallIconContainer}
        href={FACEBOOK_URL}
        target={"_blank"}
      >
        <img
    ...
    const instagramIconMarkup = (
      <a
        className={`${styles.smallIconContainer} ${
          styles.instagramIconContainer
        }`}
        href={INSTAGRAM_URL}
        target={"_blank"}
      >
        <img
          className={`${styles.smallIcon} ${styles.instagramIcon}`}
          src={instagramIcon}
    ...
    return (
      <div
        className={`${styles.smallHeader} ${invisible ? styles.invisible : ""}`}
      >
        <div className={styles.smallRow}>
          ...
          <Link to={{ pathname: "/" }} className={styles.smallTitle}>
            <span className={styles.coloured}>{"Jess"}</span>
            <span>{"Zaikova"}</span>
          </Link>

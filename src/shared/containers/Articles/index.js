...
export default class ArticlesPage extends Component {
  ...
  createMeta() {
    ...
    const description =
      "Travel articles (and anything else of interest) of Jess Zaikova around the world. USA, Russia, Czech, Prague, Serbia and much more!";
    const meta = {
      title,
      description,
      meta: {
        name: {
          keywords:
            "jess zaikova, travel, blog, articles, russia, prague, czech republic, USA, travel blog"
        },
        itemProp: {
          name: title,
          description,

      ...
      <PageFrame small wide meta={meta}>
        ...
        <div className={`${styles.list} container`} ref={this.createRef}>
          ...
          <div className={styles.elemContainer}>
            <iframe className={styles.elem} src="https://www.youtube.com/embed/93efenoGLQ0" frameBorder="0" allowFullScreen />
          </div>
          <div className={styles.elemContainer}>
            <iframe className={styles.elem} src="https://www.youtube.com/embed/x7F6PjTS7AU" frameBorder="0" allowFullScreen />
          </div>
          <div className={styles.elemContainer}>
            <iframe className={styles.elem} src="https://www.youtube.com/embed/8KVlhpn3eYc" frameBorder="0" allowFullScreen />
          </div>
          <div className={styles.elemContainer}>
            <iframe className={styles.elem} src="https://www.youtube.com/embed/UPbLyC781Ec" frameBorder="0" allowFullScreen />
          </div>
          <div className={styles.elemContainer}>
            <iframe className={styles.elem} src="https://www.youtube.com/embed/74_b4caAvQg" frameBorder="0" allowFullScreen />
          </div>
          <div className={styles.elemContainer}>
            <iframe className={styles.elem} src="https://www.youtube.com/embed/Jy-LYvDh07o" frameBorder="0" allowFullScreen />
          </div>
          <div className={styles.elemContainer}>
            <iframe className={styles.elem} src="https://www.youtube.com/embed/AcmnV2cf3qo" frameBorder="0" allowFullScreen />
          </div>
          <div className={styles.elemContainer}>
            <iframe className={styles.elem} src="https://www.youtube.com/embed/B3A2EWAZo5s" frameBorder="0" allowFullScreen />
          </div>
          <div className={styles.elemContainer}>
            <iframe className={styles.elem} src="https://www.youtube.com/embed/gcXm28KyDuQ" frameBorder="0" allowFullScreen />
          </div>
          <div className={styles.elemContainer}>
            <iframe className={styles.elem} src="https://www.youtube.com/embed/bpwFBB-LN9U" frameBorder="0" allowFullScreen />
          </div>
          <div className={styles.elemContainer}>
            <iframe className={styles.elem} src="https://www.youtube.com/embed/2s3VQnHM7vo" frameBorder="0" allowFullScreen />
          </div>
        </div>
